...
public class CustomerDaoJdbcTemplateImpl implements CustomerDao {
    ...
    private static final String ADD_CALL_SQL = "INSERT INTO CUSTOMER_CALL (TIME_AND_DATE, NOTES, CUSTOMER_ID";
    private static final String GET_CALL_BY_CUSTOMER_ID_SQL = "SELECT CALL_ID, DATE, NOTES FROM CUSTOMER_CALL WHERE CUSTOMER_ID=?";
    private static final String CREATE_TABLE_CUSTOMER_SQL = "CREATE TABLE CUSTOMER (CUSTOMER_ID VARCHAR(255), COMPANYNAME VARCHAR(255), NOTES VARCHAR(255), OWNING_USER VARCHAR(20) PRIMARY KEY (CUSTOMER_ID)";
    private static final String CREATE_TABLE_CUSTOMERS_CALL_SQL = "CREATE TABLE CUSTOMER_CALL (CALL_ID integer generated by default as identity (start with 1), TIME_AND_DATE DATE, NOTES VARCHAR(255), CUSTOMER_ID  VARCHAR(255) FOREIGN KEY (CUSTOMER_ID) REFERENCES CUSTOMER (CUSTOMER_ID) ";
